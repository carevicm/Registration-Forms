...
const FormPage = ({
  ...
  return (
    ...
    >
      <main className="login-main p-4 md:p-12 w-full md:max-w-md mx-auto bg-gradient-to-t from-white/80 to-white/60 backdrop-blur-3xl rounded-3xl shadow-md mb-4 md:mb-0 md:mr-10 flex-1">
        <div className="mb-4">
          <Header title={title} />
